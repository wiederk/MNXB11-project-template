...
# Data Preparation
Change into the directory datasets and run the bash file *./cleandata.sh* and get the file processed_data.csv.

# Data Extraction
Change into the directory datasets and run the c++ program data_extraction.cxx and get the file Extracted_data.csv.

# Data Analysis
Change into the directory MNXB11-project-template and the course container. Run make and run ./main and get the plot.
